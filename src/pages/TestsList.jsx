...
const TestsList = () => {
  ...
  const mainTest = {
    ...
    description: 'Узнайте свой ведущий архетип, сильные стороны личности и зоны роста.',
    icon: Palette,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 bg-white/10 backdrop-blur-lg rounded-3xl p-8 text-center">
          ...
          <p className="text-white/80 mb-6 max-w-xl mx-auto">
            Рекомендуем начать с теста на архетипы — это основа для понимания себя и своей динамики в отношениях
          </p>
          <Link
            to="/test/archetypes"
